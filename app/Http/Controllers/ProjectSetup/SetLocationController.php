...
class SetLocationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('project.set-location.index', compact('id', 'data', 'default', 'language', 'langSetup', 'forms', 'groupForm', 'listDrawingSet'));
    ...
    {
        $location = LocationPoint::find($id);
    ...
    public function locationDetail(Request $request){
        ...
        return DrawingPlan::with('locationOrder')->find($request->input('id'));
    }
