(function ($) {
    ...
    var init = function (index, input, options) {
        ...
        $reset = $('<button type="button" class="btn btn-primary"><i class="icon-trash"></i></button>');
        $submit = $('<button type="button" class="btn btn-primary"><i class="icon-floppy-disk"></i></button>');
        $canvas = $('<canvas>');
		...
		$("#button_location").append($submit);
		$("#button_location").append("&nbsp;", $reset);
