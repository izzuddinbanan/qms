        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">
                    ...
                    <button class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#modal_add_category" data-popup="tooltip" title="@lang('issueSetCat.newCat')" data-placement="left"><i class="icon-add"></i></button>
                </h5>
            </div>
                    ...
                    <table class="table table-bordered table-hover table-striped table-framed table-xxs">
                        ...
                        <tbody>
                            ...
                            <tr class="">
                                <td>{{ $category->name }}</td>
                                <td align="center">
                                    <a href="{{ route('client.edit', [$category->id]) }}" data-popup="tooltip" title="@lang('general.edit')" data-placement="top">
                                        <i class="fa fa-edit largeIcon" id="open_{{ $category->id }}" onclick="return editForm({!! $category->id!!})"></i>
                                    </a>
