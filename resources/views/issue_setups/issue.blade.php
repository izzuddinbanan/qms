            ...
            <div class="panel-heading">
                <h5 class="panel-title">
                    <i class="icon-gear"></i> @lang('issueSetIssue.header')
                        <button class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#modal_add_issue" onclick="return listCat()"  data-popup="tooltip" title="@lang('issueSetIssue.newIssue')" data-placement="left"><i class="icon-add"></i></button>
                </h5>
            </div>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a href="" data-popup="tooltip" title="@lang('general.edit')" data-placement="top">
                                        <i class="fa fa-edit largeIcon" id="open_{{ $issue->id }}" onclick="return editForm({{ $issue->id}})"></i>
                                    </a>
