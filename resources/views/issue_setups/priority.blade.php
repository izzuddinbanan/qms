            ...
            <div class="panel-heading">
                <h5 class="panel-title">
                    <i class="icon-gear"></i> @lang('issueSetPriority.header')
                        <button class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#modal_add_priority" data-popup="tooltip" title="@lang('issueSetPriority.newPriority')" data-placement="left"><i class="icon-add"></i></button>
                </h5>
            </div>
                    ...
                    <table class="table table-bordered table-hover table-striped table-framed table-xxs">
                        ...
                        <tbody>
                            ...
                            <tr class="">
                                ...
                                <td align="center">
                                    <a href="{{ route('client.edit', [$priority->id]) }}" data-popup="tooltip" title="@lang('general.edit')" data-placement="top">
                                        <i class="fa fa-edit largeIcon" id="open_{{ $priority->id }}" onclick="return editForm({{ $priority->id}})"></i>
                                    </a>
