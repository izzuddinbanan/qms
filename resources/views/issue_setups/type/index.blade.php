            ...
            <div class="panel-heading">
                <h5 class="panel-title">
                    ...
                    <a href="{{ route('setting_type.create') }}">
                        <button class="btn btn-primary btn-sm pull-right" data-popup="tooltip" title="@lang('issueSetType.newType')" data-placement="left"><i class="icon-add"></i></button>
                    </a>
                </h5>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr class="">
                                <td class="text-center">
                                    <input type="checkbox" name="" {{ $type->unit_owner ? 'checked' : '' }} disabled="">
                                </td>
                                <td>{{ $type->name }}</td>
                                <td>{{ $type->inCategory->name }}</td>
                                <td align="center">
                                    <a href="{{ route('setting_type.show', [$type->id]) }}" data-popup="tooltip" title="@lang('general.edit')" data-placement="top">
