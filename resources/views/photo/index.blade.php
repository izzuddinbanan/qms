					        	...
					        	<tr>
					        		<td>
					        			<div class="row">
					        				...
					        				<div class="col-md-8">
					        					<input class="form-control" id="display_name" name="display_name" value="{{$handover_menu->display_name}}" placeholder="e.g Photo">
					        				</div>
					        			</div>
					        			<div class="row">
					        				<div class="col-md-4">
		                            ...
		                            <span class="slider round"></span>
					        			...
					        			<div class="row text-right">
	                    					<a href="{{route('handover.index')}}" name="survey" class="btn btn-danger">Cancel</a>
	                    					<button type="submit" name="photo_submit" class="btn btn-primary">Save <i class="icon-arrow-right14 position-right"></i></button>
					        			</div>	
					        		</td>
					        	</tr>
					        </tbody>
