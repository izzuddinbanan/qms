        ...
        <div class="panel panel-flat" >
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <form action="{{ route('buyer.update', [$user->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="buyer_id" id="buyer_id" value="{{ $user->buyer_id }}" autocomplete="off" autofocus="" placeholder="" autocomplete="">
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="form-group">
                                <label class="text-semibold">@lang('main.email') :</label>
                                <input type="text" class="form-control" value="{{ $user->email }}" autocomplete="off" autofocus="" readonly="">
                            </div>
                        </div>
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="name" value="{{ $user->name }}" autocomplete="off" autofocus="" required="">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ic_no" id="ic_no" value="{{ $user->ic_no }}" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="text-semibold">Passport No :</label>
                                <input type="text" class="form-control" name="passport_no" id="passport_no" value="{{ $user->passport_no }}" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="text-semibold">Company Reg No :</label>
                                <input type="text" class="form-control" name="company_reg_no" id="company_reg_no" value="{{ $user->comp_reg_no }}" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="house_no" id="house_no" value="{{ $user->house_no }}" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="text-semibold">Office No :</label>
                                <input type="text" class="form-control" name="office_no" id="office_no" value="{{ $user->house_no }}" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="mail_address" id="mail_address">{{ $user->mailing_address }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="select-search" readonly="">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select data-placeholder="Please Select" class="select-search" readonly="">
                                    <option>{{ $drawingPlan->drawingSet->project->name }}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select data-placeholder="Please Select" class="select-search">
                                    <option>{{ $drawingPlan->block .'-' . $drawingPlan->level .'-' . $drawingPlan->unit }}</option>
                                </select>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="unit-information">
                            <div class="unit-field">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="text-semibold">Category :</label>
                                        <select data-placeholder="Please Select" class="select-search owner-category" name="owner_category[]" onchange="listProject(this)">
                                            <option value="">Please Select</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="text-semibold">Project :</label>
                                        <select data-placeholder="Please Select" class="select-search list-project" name="owner_project[]" onchange="listUnit(this)">
                                            <option value="">Please Select</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="text-semibold">Unit :</label>
                                        <select data-placeholder="Please Select" class="select-search list-unit" name="owner_unit[]" onchange="filterUnit(this)">
                                            <option value="">Please Select</option>
                                        </select>
                                    </div>
                                </div>
