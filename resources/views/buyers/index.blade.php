        ...
        <div class="panel panel-flat" >
            <div class="panel-heading">
                <h5 class="panel-title">
                    <i class="icon-users"></i> Buyers
                        <a class="" href="{{ route('buyer.create') }}">
                            <button class="btn btn-primary pull-right btn_cust">Add New</button>
                        </a>
                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">Mr/Mrs:</label>
                                    <div class="col-lg-9">
                                        <select data-placeholder="Select Drawing Set" class="select-search" name="salutation" id="salutation" required="">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">Handphone No:</label>
                                    <div class="col-lg-9">
