    ...
    <div class="panel-heading">
        <div class="row">
            <div class="col-md-8 col-xs-8">
                <h4 class="panel-title textUpperCase"><i class="icon-insert-template"></i> New Handover Form</h4>
            </div>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
            	<form action="{{ route('handover-form.store') }}" method="POST">
                    @csrf
                    <div class="row" style="margin-bottom: 10px;">
	                    <div class="col-md-8">
                            <input type="textbox" name="name" value="{{ old('name') ? old('name') : 'Checklist with Appointment' }}" placeholder="Form Title e.g Key Form" class="form-control remove-border" style="font-size: 17px;font-weight: bold;" autocomplete="off" required="">
	                    </div>
	                    <div class="col-md-12">
                            <textarea class="form-control remove-border" name="description" placeholder="checklist description"></textarea>
	                    </div>
	                </div>
		                ...
		                <div class="panel panel-content section-field" style="padding: 10px;">
		                	<div class="row">
		                		...
		                		<div class="col-md-12" style="margin-bottom: 10px;">
	                            	<input type="textbox" name="section[]" value="{{ old('section')[0] ? old('section')[0] : '' }}" placeholder="Input section here e.g Entrance" class="form-control remove-border" autocomplete="off">
		                		</div>
			                    <div class="col-md-12">
