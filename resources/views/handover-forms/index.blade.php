    ...
    <div class="panel-heading">
        <div class="row">
            ...
            <div class="col-md-4 col-xs-4 text-right">
                <a href="{{ route('handover-form.create') }}" type="button" class="btn bg-teal-400 btn-labeled btn-labeled-right"><b><i class="icon-file-plus"></i></b> @lang('main.add_new')</a>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#table-data').DataTable({
            ...
            ajax: "{{ route('handover-form.index-data') }}",
            columnDefs: [
                {
