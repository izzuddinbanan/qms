@extends('components.template-limitless.main') @section('main')
<style>
body {
...
<div class="content" id="screenarea">
	<div class="panel panel-flat">
		<div class="panel-body">
			<div class="row">
                <div class="col-md-8 col-xs-8 panel panel-flat">
                    <div id="top_form_menu" class="row" data-spy="affix" data-offset-top="100">
                        <div class="form-group col-md-4 col-xs-4"> 
                            <div class="input-group" style="left">
                                <input type="text" class="form-control" readonly id="current_mode">
                                <div class="input-group-btn">
                                    <button type="button" class="btn btn-icon" onclick="switchMode()"><i class="icon-git-compare"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-md-4 col-xs-4"> 
                            <div class="input-group">
                                <div class="input-group-btn">
                                    <button type="button" class="btn btn-icon btn-prev" onclick="prevForm()"><i class="icon-previous2"></i></button>
                                </div>
                                <input type="text" class="form-control" readonly id="current_form_index">
                                <div class="input-group-btn">
                                    <button type="button" class="btn btn-icon btn-next" onclick="nextForm()"><i class="icon-next2"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-md-2 col-xs-4"> 
                            <button class="btn btn-sm btn-icon" style="width: 40px;" onclick="printElement()"> <i class="fa fa-print"></i> </button> 
                ...
                <div class="col-md-4 col-xs-4"> 
                    <div id="image_file_detail" class="row btn-for-setup" data-spy="affix" data-offset-top="100" style="top:60px !important; display: none;position: relative" >
                        <div class="col-md-12 col-xs-12" style="padding-bottom: 10px">
                            <div style="float: left;">
                                <button data-toggle="modal" class="btn btn-primary btn-sm btn-form" style="height: 36px;" data-target="#modal_add_location"> <i class="fa fa-plus" aria-hidden="true"></i> Input </button>
                                <button onclick="saveAll()" class="btn btn-primary btn-sm btn-form" style="height: 36px;"> <i class="fa fa-save" aria-hidden="true"></i> Save </button>
                                <button data-toggle="modal" class="btn btn-primary btn-sm btn-form" style="height: 36px;" data-target="#modal_show_sections"> <i class="fa fa-eye" aria-hidden="true"></i> Section </button>    
                            </div>
                        </div>
                        <div class="col-md-12 col-xs-12">
                            <div class="panel panel-flat">
                                <div class="panel-heading detail-panel-heading">
                                    <h3 class="panel-title" style="font-size:16px; font-weight:400;"> Detail </h3>
                                    <span style="font-size:12px"><i class="fa fa-info"></i> <i>Double click at the marker to select. </i></span>
                                </div>
                                
                                <div class="panel-body detail-panel-body">
                                    <form id="form_option" style="display: none;">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <input type="hidden" id="modal_option_mode" value="">
                                                <input type="hidden" id="modal_option_index" value="">
                                                <div class="form-group">
                                                    <label>Title <span style="color: red;"> * </span></label>
                                                    <input autocomplete="off" type="text" id="modal_option_title" class="form-control" required> 
                                                </div>         

                                                <div class="form-group">
                                                    <label>Option</label> 
                                                    <select required class="form-control" id="modal_option_attribute" class="select" disabled>
                                                ...
                                                <div class="form-group">
                                                    <label>Roles</label>
                                                    <select id="modal_option_roles" multiple="multiple" data-placeholder="Enter Roles" class="select">
                                                ...
                                                <div class="form-group">
                                                    <label>Section</label>
                                                    <select id="modal_option_section" class="select">
                                                ...
                                                <div class="form-group option-dropdown-value">
                                                    <label>Dropdown Menu <span style="color: red;"> * </span></label> 
                                                    <input id="modal_option_dropdown_value" value="" data-role="tagsinput">
                                                </div>
                    
                                                <div class="form-group option-no-row">
                                                    <label>Number of row <span style="color: red;"> * </span></label> 
                                                    <input autocomplete="off" type="number" id="modal_option_no_row" value="1" min="1" class="form-control"> 
                                                </div>
                                                
                                                <div class="form-group option-no-input">
                                                    <label>Number of Input </label> 
                                                    <input autocomplete="off" type="number" id="modal_option_no_input" value="1" min="1" class="form-control" disabled> 
                                                </div>
                                                ...
                                                <div class="form-group">                                                    
                                                    ...
                                                    <div class="checkbox checkbox-switchery switchery-sm switchery-double">
                                                        <label>
                                                            No
                                                            <input id="modal_option_mandatory" type="checkbox">
                                                            Yes
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div style="float: left">     
                                                        <button type="button" onclick="removeCurrentAttribute()" class="btn btn-primary btn-sm">Remove</button>
                                                    </div>
                                                    <div style="float: right">     
                                                        <button type="submit" class="btn btn-primary btn-sm">Save</button>
                                                        <button type="button" class="btn btn-danger btn-sm" onclick="cancelCurrentAction()">Cancel</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<!-- modal_section-->
<div id="modal_section" class="modal fade" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h5 class="modal-title" id="modal_section_title"> Section </h5>
            </div>
            <form id="form_section">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <input type="hidden" id="form_section_id" value="0">
                            <div class="form-group">
                                <label>Section Name</label> 
                                <input autocomplete="off" placeholder="Section A(1)" type="text" id="form_section_name" value="" class="form-control" required> 
                            </div>

                            <div class="form-group">
                                <label>Step</label> 
                                <input autocomplete="off" placeholder="1" type="number" id="form_section_sequence" value="0" min="0" class="form-control" required> 
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary btn-sm">Save</button>
                    <button type="button" class="btn btn-danger btn-sm" onclick="cancelModalSection()">Cancel</button>
                </div>
            </form>
        </div>
    </div>
...
<div id="modal_show_sections" class="modal fade" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h5 class="modal-title"> Section list</h5>
            </div>

            <div class="modal-body">
                <button class="btn btn-primary btn-sm" style="height: 36px;" onclick="showModalSection()"> <i class="fa fa-plus" aria-hidden="true"></i> Section </button>
                        ...
                        <tr>
                            <td>
                                <div class="media-left">
                                    <div class=""><span class="text-default text-semibold">{{ $section->name }}</span></div>
                                    <div class="text-muted text-size-small"><span class="status-mark border-blue position-left"></span> Step {{ $section->sequence }}</div>
                                </div>
                            </td>
                            <td class="text-center" align="center">
                                <a data-popup="tooltip" data-placement="top" data-original-title="Edit" onclick="showModalSection({{ $section->id }})"><i class="fa fa-edit largeIcon"></i></a>
                                <a data-popup="tooltip" data-placement="top" data-original-title="Delete" onclick="deleteSection({{ $section->id }})"><i class="fa fa-trash largeIcon"></i></a>
                            </td> 
                        </tr>
                    @empty
                    <tr>
...
<script type="text/javascript">
    ...
    function draw(current_index, element, mode) {   
        ...
        element["locations"].forEach((location, index) => {
            ...
            switch (attribute["id"]) {
                case 1:
                    $("#image_file_container").append('<div id="' + id + '"><p style="float: left"><i> A super long description </i></p></div>');                    
                    break;
                case 2:
                    $("#image_file_container").append('<div id="' + id + '"><p style="float: left"><i> A short sentence </i></p> </div>');
                    break;
                case 3:
                    $("#image_file_container").append('<div id="' + id + '"><p style="float: left"><i> Signature </i></p> </div>');
                    break;
                case 4:
                    break;
                case 5:
                    $("#image_file_container").append('<div id="' + id + '"><p style="float: left"><i> 18/09/20XX </i></p> </div>');
                    break;
                case 6:
                case 8:
                    $("#image_file_container").append('<div id="' + id + '"><div style="position: relative;"><div style="position: absolute; z-index: 3; top:0px; min-height: 100%; min-width: 100%;"></div><input type="checkbox" class="styled" checked="checked" disabled></div></div>');
                    break;
                case 7:
                    $("#image_file_container").append('<div id="' + id + '"><div style="position: relative;"><div style="position: absolute; z-index: 3; top:0px; min-height: 100%; min-width: 100%;"></div><input type="radio" class="styled" checked="checked" disabled></div></div>');
                    break;
                case 9:
                    $("#image_file_container").append('<div id="' + id + '"><i style="float: right; margin-right:10px;" class="fa fa-sort-down"></i></div>');       
                    break;
            }
            ...
            $("#" + id)                
                .dblclick(function(event) {
                    ...
                    if (!$(this).hasClass("editing-mode") ) {
                        ...
                        // $("#modal_option_title, #modal_option_no_row, #modal_option_mandatory").on("input", function() {
                        //     console.log("damn input only");
                        // });

                        // $("#modal_option_roles").on("change.select2", function() {
                        //     console.log("damn select change role");
                        // });

                        // $("#modal_option_section").on("change.select2", function() {
                        //     console.log("damn select change section");
                        // });

                        // // $("#modal_option_dropdown_value").on("change.select2", function() {
                        // //     console.log("damn select change dropdown");
                        // // });

                        // $("#modal_option_dropdown_value").on("change.select2", function(event) {
                        //     console.log("damn select change dropdown");
                        ...
                        //     var option = $("#modal_option_attribute").val();
                        //     if (option != "" && option != undefined) {
                        //         $(".bootstrap-tagsinput input").prop("required", false);
                        //         if (option == "9") {
                        //             var dropdownOption = $element.tagsinput("items");
                        //             $(".bootstrap-tagsinput input").prop("required", (dropdownOption.length <= 0 ? true : false));
                        //         }
                        //     }
            ...
            formAttributesHolder[currentFormIndex]["attributes"].forEach((element, index) => {
                element["locations"].forEach((location, l_index) => {
                    ...
                    switch (element["attribute_id"]) {
                        case 1:
                            $("#image_file_container").append('<textarea maxlength="255" id="' + current_id + '"></textarea>');
                            break;
                        case 2:
                            $("#image_file_container").append('<input type="text" autocomplete="off" maxlength="100" id="' + current_id + '">');  
                            break;
                        case 3:
                            $("#image_file_container").append('<div onclick="showSignatureModal(' + '\'' + current_id + '\'' + ')" id="' + current_id + '"></div>');  
                            break;
                        case 4:
                            break;
                        case 5:
                            $("#image_file_container").append('<input type="date" id="' + current_id + '">');   
                            break;
                        case 6:
                        case 8:
                            $("#image_file_container").append('<div id="' + current_id + '"><input type="checkbox" class="styled"></div></div>');
                            break;
                        case 7:
                        ...
                        case 9:
                            ...
                            $("#image_file_container").append('<select placeholder="select one" id="' + current_id + '">' + string_element + '</select>');
                            break;
                    }
    ...
    function showSignatureModal(id) {
        $("#modal_signature_box").modal('toggle');
