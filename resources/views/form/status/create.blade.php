        ...
        <div class="panel panel-flat" >
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <form action="{{ route('form-status.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" value="{{ old('name') }}" autocomplete="off" autofocus="" required="" placeholder="e.g. Closed">
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="col-md-4">
                            <label class="text-semibold">@lang('main.colorPicker') :</label>
                            <input type="text" class="form-control colorpicker-basic" value="{{ old('colorcode') }}" id="color-picker">
                            <input type="hidden" name="colorcode" value="{{ old('colorcode') }}" id="colorcode">
                        </div>
