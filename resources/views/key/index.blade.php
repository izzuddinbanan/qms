				        	...
				        	<tr>
				        		<td>
				        			<div class="row">
				        				...
				        				<div class="col-md-8">
				        					<input class="form-control" id="display_name" value="{{$handover_menu->display_name}}" name="display_name" placeholder="e.g Key">
				        				</div>
				        			</div>
				        			<div class="row">
				        				<div class="col-md-4">
				        				...
				        				<div class="col-md-8">
				        					<label class="switch">
                              <input type="checkbox" id="key" name="key" onclick="key()" checked>
                              <span class="slider round"></span>
				        			...
				        			<div class="row text-right">
                    					...
                    					<button type="submit" name="key_submit" class="btn btn-primary">Save <i class="icon-arrow-right14 position-right"></i></button>
				        			</div>	
				        		</td>
				        	</tr>
				        </tbody>
